calculateDeformationMARLSpar MATLAB Python Package
...
2. Installing the calculateDeformationMARLSpar Package

A. Change to the directory that contains the file setup.py and the subdirectory 
calculateDeformationMARLSpar. If you do not have write permissions, copy all its contents 
...
3. Using the calculateDeformationMARLSpar Package

The calculateDeformationMARLSpar package is on your Python path. To import it into a 
