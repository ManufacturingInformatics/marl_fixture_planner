...
if __name__ == '__main__':
    setup_dict = {
        'name': 'calculateDeformationMARLTEST-R2023a',
        'version': '9.14',
        'description': 'A Python interface to calculateDeformationMARLTEST',
        'author': 'MathWorks',
        'url': 'https://www.mathworks.com/',
        'platforms': ['Linux', 'Windows', 'macOS'],
        'packages': [
            'calculateDeformationMARLTEST'
        ],
        'package_data': {'calculateDeformationMARLTEST': ['*.ctf']}
    }
