...
class Evaluator:
    ...
    def __init__(self):
        ...
        self.reward_storage = f'./runs_csv/marl_{self.env.num_agents}_agents/evaluation/rewards.csv'
        
        self.action_storage = f'./runs_csv/marl_{self.env.num_agents}_agents/evaluation/actions.csv'
        
        self.context_storage = f'./runs_csv/marl_{self.env.num_agents}_agents/evaluation/contexts.csv'
        ...
        for i in range(self.env.num_agents):
            ...
            self.agents[agent_id].policy_net.load_state_dict(torch.load(f'./runs_csv/marl_{self.env.num_agents}_agents/run_{self.run_name}/agent_{agent_id}_dict.pt', map_location=self.config['device']))
