...
if __name__ == '__main__':
    setup_dict = {
        'name': 'calculateDeformationMARLSpar-R2023a',
        'version': '9.14',
        'description': 'A Python interface to calculateDeformationMARLSpar',
        'author': 'MathWorks',
        'url': 'https://www.mathworks.com/',
        'platforms': ['Linux', 'Windows', 'macOS'],
        'packages': [
            'calculateDeformationMARLSpar'
        ],
        'package_data': {'calculateDeformationMARLSpar': ['*.ctf']}
    }
